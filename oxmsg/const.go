...
var (
	PS_PUBLIC_STRINGS           = cfb.GUID{0x00020329, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_Common               = cfb.GUID{0x00062008, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_Address              = cfb.GUID{0x00062004, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PS_INTERNET_HEADERS         = cfb.GUID{0x00020386, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_Appointment          = cfb.GUID{0x00062002, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_Meeting              = cfb.GUID{0x6ED8DA90, 0x450B, 0x101B, [8]byte{0x98, 0xDA, 0x00, 0xAA, 0x00, 0x3F, 0x13, 0x05}}
	PSETID_Log                  = cfb.GUID{0x0006200A, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_Messaging            = cfb.GUID{0x41F28F13, 0x83F4, 0x4114, [8]byte{0xA5, 0x84, 0xEE, 0xDB, 0x5A, 0x6B, 0x0B, 0xFF}}
	PSETID_Note                 = cfb.GUID{0x0006200E, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_PostRss              = cfb.GUID{0x00062041, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_Task                 = cfb.GUID{0x00062003, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_UnifiedMessaging     = cfb.GUID{0x4442858E, 0xA9E3, 0x4E80, [8]byte{0xB9, 0x00, 0x31, 0x7A, 0x21, 0x0C, 0xC1, 0x5B}}
	PS_MAPI                     = cfb.GUID{0x00020328, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_AirSync              = cfb.GUID{0x71035549, 0x0739, 0x4DCB, [8]byte{0x91, 0x63, 0x00, 0xF0, 0x58, 0x0D, 0xBB, 0xDF}}
	PSETID_Sharing              = cfb.GUID{0x00062040, 0x0000, 0x0000, [8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	PSETID_XmlExtractedEntities = cfb.GUID{0x23239608, 0x685D, 0x4732, [8]byte{0x9C, 0x55, 0x4C, 0x95, 0xCB, 0x4E, 0x8E, 0x33}}
	PSETID_Attachment           = cfb.GUID{0x96357F7F, 0x59E1, 0x47D0, [8]byte{0x99, 0xA7, 0x46, 0x51, 0x5C, 0x18, 0x3B, 0x54}}
)
